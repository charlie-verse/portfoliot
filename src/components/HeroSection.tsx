        ...
        <div className="w-full flex justify-center py-5 pt-44 dark:bg-black">
            <div className="w-2/3 max-sm:w-full flex flex-col items-center">
                ...
                <div className="mt-4 px-32 max-sm:px-4">
                    ...
                    <h1 className={`mt-2 max-sm:mt-5 max-sm:px-3 !text-base max-sm:!text-sm text-center !font-normal !tracking-normal inter !leading-6 ${inter}`}>22, i break things, learn fast, and make shit happen. deep into code and cs; anything that pushes the limits. history, curiosity, cricket, and great books shaped me. still chasing mastery.
                        <br />
